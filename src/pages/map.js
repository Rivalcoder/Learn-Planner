...
export default function LearningPathGenerator() {
  ...
  return (
    <div className="bg-gradient-to-br py-14 max-h-screen overflow-y-scroll from-gray-900 via-gray-800 to-black min-h-screen text-white">
      <Head>
      ...
      {topics.length > 0 && (
        <div className="min-h-screen -mt-8">
          ...
          <motion.div 
            ...
            className="bg-gradient-to-r from-gray-900/95 to-gray-800/95 backdrop-blur-xl border-b border-gray-700/50"
          >
            <div className="max-w-7xl mx-auto px-6 py-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                  <button
                    onClick={handleReset}
                    className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-800/60 hover:bg-gray-700/60 text-gray-300 hover:text-white transition-all duration-300 border border-gray-700/50"
                  >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400 capitalize">{selectedDifficulty} Level</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-indigo-400">{overallProgress}%</div>
            ...
            >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-white">
                      {topics.reduce((acc, topic) => acc + topic.subtopics.filter(sub => sub.completed).length, 0)}
                    </div>
              ...
              <div className="bg-gray-800/60 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-white">
                      {Math.round((topics.reduce((acc, topic) => acc + topic.progress, 0) / topics.length) / 10) * 10}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-400">
                            {topic.subtopics.length} learning objectives
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <div className="text-2xl font-bold text-indigo-400">{topic.progress}%</div>
